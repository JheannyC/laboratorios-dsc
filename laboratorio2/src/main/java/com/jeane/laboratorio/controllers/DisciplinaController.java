...
public class DisciplinaController {
    ...
    public ResponseEntity<DisciplinaLikesDTO> addLikes(@PathVariable Long id) throws Exception {
        try {
    ...
    public ResponseEntity<DisciplinaNotasDTO> addNota(@PathVariable Long id, @RequestBody NotaDTO notaDTO) throws Exception {
        try {
    ...
    public ResponseEntity<DisciplinaComentarioDTO> addComentario(@PathVariable Long id, @RequestBody ComentarioDTO comentarioDTO) throws Exception {
        try {
